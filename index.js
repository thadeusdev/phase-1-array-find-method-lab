...
// function filter(collection, element1, value1, element2, value2){
//     for (const win of collection){
//         if(win[element1] === value1 && win[element2] === value2){
//             return win.year
//         }
//     }
// }
...
function superbowlWin(record){
    let element = record.find(element => element.result === "W");
    if(element){
        return element.year;
    }else{
        return undefined;
...
// findWin = filter(record, 'result', 'W')